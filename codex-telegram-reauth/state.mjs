...
function normalizeSession(raw) {
  ...
  return {
    ...
    verifier: normalizeString(source.verifier),
    expectedState: normalizeString(source.expectedState),
...
export function startReauthSession(state, params, now = Date.now()) {
  ...
  state.session = {
    ...
    verifier: normalizeString(params.verifier),
    expectedState: normalizeString(params.expectedState),
    createdAt: now,
...
export function buildStatus(state) {
  ...
  return {
    ...
    session: {
      ...
      profileId: normalized.session.profileId || null,
